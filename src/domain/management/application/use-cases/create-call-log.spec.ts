...
describe('Create Call Log', () => {
  beforeEach(() => {
    ...
    sut = new CreateCallLogUseCase(inMemoryCooperatorRepository, inMemoryCallLogRepository)
  })
  it('should be able to Create a Call Log', async () => {
    ...
    expect(result.value).toEqual({ callLog: inMemoryCallLogRepository.items[0] })
  })
