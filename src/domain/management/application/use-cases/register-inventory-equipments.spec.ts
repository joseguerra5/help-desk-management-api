...
describe('Register inventory', () => {
  beforeEach(() => {
    ...
    sut = new RegisterInventoryUseCase(inMemoryCooperatorRepository, inMemoryCooperatorEquipmentRepository, inMemoryLoanRecordRepository)
  })
  ...
  it('should be able Register a loan record check-in and chek-out with only one execute', async () => {
    ...
    await inMemoryCooperatorEquipmentRepository.createMany([equipment, equipment2])
